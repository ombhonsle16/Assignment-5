...
export default function Navbar() {
    return (
        ...
        <div className="col-2">
        <img src={Logo} className="custom-logo img-thumbnail"/>
        </div>
        <div className="col-8">
      ...
      <ul className="navbar-nav me-auto mb-2 mb-lg-0 d-flex flex-row justify-content-evenly custom-link-nav" >
        ...
        <button type="button" class="btn btn-success btn-lg custom-btn-donate"style={{backgroundColor:"#660066" }} >DONATE US</button>
        </div>
        </div>
    )
}
